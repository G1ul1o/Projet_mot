...
void type1(t_tree, t_tree, t_tree); // forme le type de phrase : Nom Adjectif Verbe Nom
void type2(t_tree, t_tree, t_tree); // forme le type de phrase : Nom qui Verbe Verbe Nom Adjectif
void type3(t_tree, t_tree, t_tree,t_tree); // forme le type de phrase : Jean-Louis le Adjectif Verbe Nom Adjectif
